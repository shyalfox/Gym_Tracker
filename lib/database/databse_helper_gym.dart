...
class DatabaseHelper {
  ...
  static const String _dbName = 'chestFinal.db';
  ...
  static Future<void> chestTable(Database db, String partBody) async {
  ...
  Future<Map<String, dynamic>?> getChestData(int id, String partBody) async {
    Database db = await initDatabase(partBody: partBody);
